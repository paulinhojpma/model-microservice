...
type Configuracoes struct {
	...
	MessagingURL    string `json:"messagingURL" env:"MESSAGING_URL"`        // "messaging": "../../config-msgs.json",
	MessagingDriver string `json:"messagingDriver" env:"MESSAGING_DRIVER"`  // "messaging": "../../config-msgs.json",
